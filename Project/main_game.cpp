...
void Game::start_round()
{
    ...
    glm::vec2 player_start_pos = m_levels.at(0)->get_start_pos();
    ...
    m_player->init(player, hp * 0.5, damage, speed * 1.5, ammo_max * 2, reload_time,
    ...
    for (size_t i = 0; i < m_bots.size(); i++)
    {
        m_bots.at(i)->init(bot, hp, damage, speed, ammo_max, reload_time,
